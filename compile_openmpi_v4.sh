...
BUILD_CPPFLAGS="-include stdlib.h -D_GNU_SOURCE"
BUILD_CFLAGS="-fPIC -Oz"
BUILD_CXXFLAGS="-fPIC -Oz"
...
# Usamos DESTDIR aquí para separar la instalación del destino final
