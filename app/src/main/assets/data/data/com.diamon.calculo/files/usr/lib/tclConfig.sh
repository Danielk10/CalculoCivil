...
TCL_EXTRA_CFLAGS='-fPIC -fPIE -Oz -ffile-prefix-map== -pipe -I/data/data/com.diamon.calculo/files/usr/include -I/data/data/com.termux/files/usr/include'
...
TCL_LD_FLAGS='-pie -Wl,-z,max-page-size=16384 -L/data/data/com.diamon.calculo/files/usr/lib -L/data/data/com.termux/files/usr/lib -Wl,--export-dynamic '
