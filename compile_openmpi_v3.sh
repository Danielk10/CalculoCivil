...
echo "=== Inyectando -include stdlib.h en Makefiles ==="
# Busca todas las líneas que definen CFLAGS y CXXFLAGS y añade -include stdlib.h
find . -name "Makefile" -exec sed -i 's/^CFLAGS =/CFLAGS = -include stdlib.h/g' {} +
find . -name "Makefile" -exec sed -i 's/^CXXFLAGS =/CXXFLAGS = -include stdlib.h/g' {} +
